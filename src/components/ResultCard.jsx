...
import { Bookmark, BookmarkCheck, Download, Maximize2, Play, Sparkles } from "lucide-react";
      ...
      <div className="relative w-full overflow-hidden bg-white/5">
        ...
        {item.type === "video" && (
          <div className="relative w-full aspect-video bg-black/40">
            ...
            />
            {/* Video duration/indicator badge */}
        ...
        {/* Hover / Tap Quick Overlay Controls */}
        <div
        ...
        >
          ...
          <div className="flex justify-end gap-2">
            <button
              ...
              className={`p-2.5 rounded-xl backdrop-blur-md transition-all duration-200 active:scale-90 cursor-pointer min-w-[40px] min-h-[40px] flex items-center justify-center ${
                isSaved
                  ? "bg-rose-500 text-white shadow-lg shadow-rose-500/40"
                  : "bg-black/60 text-white hover:bg-white/20 border border-white/20"
              }`}
            >
